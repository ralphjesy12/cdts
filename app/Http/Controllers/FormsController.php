...
class FormsController extends Controller {
	...
	*/
	...
	public function saveAnswerInteractive(Request $request)
	{
		...
		public function saveAnswerInteractiveMcburger(Request $request)
		{
			...
			public function saveAnswerInteractivePracticeMcburger(Request $request)
			{
				...
				$assessment = User::find($user->id)->assessment()->where([
					...
					return redirect()->intended('/assessment/interactivepractice/'.$input['code'].'/result');
						...
						public function saveAnswerInteractivegrill(Request $request)
						{
							...
							public function saveAnswerInteractivePracticegrill(Request $request)
							{
								...
								$assessment = User::find($user->id)->assessment()->where([
									...
									return redirect()->intended('/assessment/interactivepractice/'.$input['code'].'/result');
														...
														public function saveAnswerInteractivespaghetti(Request $request)
														{
															...
															public function saveAnswerInteractivePracticespaghetti(Request $request)
															{
