		...
		<div class="row">
			...
			<div class="col-xs-12">
				...
				@elseif($exam->code=='grill')
					...
					@elseif($exam->code=='spaghetti')
							<div id="flashContent">
								<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="100%" height="400" id="assembler" align="middle">
									<param name="movie" value="{{ asset('/img/interactive/spaghetti/assembler.swf') }}" />
									<param name="quality" value="high" />
									<param name="bgcolor" value="#ffffff" />
									<param name="play" value="true" />
									<param name="loop" value="true" />
									...
									<param name="allowScriptAccess" value="sameDomain" />
									<!--[if !IE]>-->
									<object type="application/x-shockwave-flash" data="{{ asset('/img/interactive/spaghetti/assembler.swf') }}" width="550" height="400">
										<param name="movie" value="{{ asset('/img/interactive/spaghetti/assembler.swf') }}" />
										<param name="quality" value="high" />
										<param name="bgcolor" value="#ffffff" />
										<param name="play" value="true" />
						...
						@elseif($exam->code=='fries')
								<div id="flashContent">
									<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="100%" height="400" id="assembler" align="middle">
										<param name="movie" value="{{ asset('/img/interactive/fries/assembler.swf') }}" />
										<param name="quality" value="high" />
										<param name="bgcolor" value="#ffffff" />
										<param name="play" value="true" />
										<param name="loop" value="true" />
										...
										<param name="allowScriptAccess" value="sameDomain" />
										<!--[if !IE]>-->
										<object type="application/x-shockwave-flash" data="{{ asset('/img/interactive/fries/assembler.swf') }}" width="550" height="400">
											<param name="movie" value="{{ asset('/img/interactive/fries/assembler.swf') }}" />
											<param name="quality" value="high" />
											<param name="bgcolor" value="#ffffff" />
											<param name="play" value="true" />
