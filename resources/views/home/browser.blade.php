		...
		<div class="col-xs-12" style="max-height:500px;overflow-y:auto;">
			...
			<div class="col-sm-4">
				...
				<form method="POST" enctype="multipart/form-data">
					...
					{!! csrf_field() !!}
					<input type="file" class="form-control input-xs" button="upload-btn" name="file">
					<button class="btn btn-default btn-xs" id="upload-btn"><i class="fa fa-fw fa-upload"></i>Upload</button>
				</form>
			</div>
